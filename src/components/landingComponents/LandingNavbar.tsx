      ...
      {LINKS.map(({ title, href }) => (
        <li key={title}>
          ...
          <Typography
            ...
            to={href}
            type="small"
            className="flex items-center gap-x-2 p-1 hover:text-orange-600 transition-all duration-500"
          >
    ...
    <div className="w-full">
      <Navbar>
        <div className="sticky lg:mx-auto w-full flex items-center lg:justify-around justify-start px-6">
          {/*------------LOGO ve HR------------*/}
          <div className={"flex items-center gap-3 -mt-0.25 "}>
            {/* Link ile logoyu sar ve route ile "/" yönlendirme yap */}
            <Link to={"/"}>
              <img
                src="/logo_navbar.png"
                alt="nature-image"
